 ...
 */
package com.dao.sys.modules.act.service.ext;
...
import com.dao.dao.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.dao.dao.entity.sys.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.dao.dao.entity.sys.User(null, userId)))){
