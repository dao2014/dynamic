 ...
 */
package com.dao.sys.modules.gen.web;
...
import com.dao.sys.modules.gen.service.GenSchemeService;
import com.dao.sys.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.dao.sys.modules");
		}
